    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                ...
                <br><br>
                <transition :name="alertAnimation" @enter="enter">
                  <div
                ...
                <transition :name="alertAnimation" mode="out-in">
                  <div
                    class="alert alert-info"
                    v-if="show"
                    key="info">This is some info.</div>
                  <div
                    class="alert alert-warning"
                    v-else
                    key="warning">This is some warning.</div>
                </transition>
                <hr> <!-- Leaving CSS World  -->
...
.slide-leave-active {
  ...
  opacity: 0;
  position: absolute;
  /* position: absolute; helps the slide-out transition not be blocky. */
  /* something about the document order and flow */
}
.slide-move {
